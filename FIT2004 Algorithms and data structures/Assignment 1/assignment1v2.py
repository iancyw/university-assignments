...
def find_rotations(string_list, p):
    ...
    radix_sort_string(equalised_og_list)
    ...
    radix_sort_string(equalised_rotated_list)

    equalised_og_list.extend(equalised_rotated_list)            # list.extend; O(n), where n is len of other list
